module.exports = {
  ...
  'Community Edition 1.0.0 Alpha': '社区版 1.0.0 Alpha',
  'Community Edition 1.0.0 Beta': '社区版 1.0.0 Beta',
  'Community Edition 1.0.0 GA': '社区版 1.0.0 GA',
  'Report the Bug': '报告 Bug',
  ...
  'Participate in the upstream projects of KubeSphere such as Kubernetes, Docker, Kata, etc.':
    '参与到 Kubesphere 的上游项目如 Kubernetes、Docker、Kata 等',
  Communication: '日常沟通',
