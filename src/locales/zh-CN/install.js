module.exports = {
  'KubeSphere Installation': 'KubeSphere 安装',
  ...
  'All-in-One deployment': 'All-in-One 单节点部署',
  'Multi-Node cluster deployment': 'Multi-Node 多节点集群部署',
  'Multi-Node mode allows you to deploy KubeSphere in production environments':
    'Multi-Node 模式支持您在生产环境部署 KubeSphere',
  'It‘s only recommended to understand KubeSphere features':
    '仅建议您用来了解 KubeSphere 功能特性',
}
